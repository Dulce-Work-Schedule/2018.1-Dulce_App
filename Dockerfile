...
ENV ANDROID_SDK_FILE android-sdk_r24.2-linux.tgz

## Install 32bit support for Android SDK
RUN dpkg --add-architecture i386 && \
    apt-get update -q && \
    apt-get install -qy --no-install-recommends libstdc++6:i386 libgcc1:i386 zlib1g:i386 libncurses5:i386 libc6-i386 lib32stdc++6 lib32gcc1 lib32ncurses5 lib32z1 file
